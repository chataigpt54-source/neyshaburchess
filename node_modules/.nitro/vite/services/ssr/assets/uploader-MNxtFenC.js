...
import { r as uploadMedia } from "./media-MH63f_AJ.js";
import { t as Button } from "./button-CeZ5edYX.js";
import { useCallback, useState } from "react";
import { jsx, jsxs } from "react/jsx-runtime";
import { toast } from "sonner";
import { Upload, X } from "lucide-react";
//#region src/components/media/uploader.tsx
...
function MultiImageUploader({ ids, onChange, coverId, onCover }) {
	...
	return /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("label", {
		...
		children: ids.map((id, index) => /* @__PURE__ */ jsxs("div", {
			draggable: true,
...
function PdfUploader({ value, onChange }) {
	...
	return /* @__PURE__ */ jsxs("div", { children: [
		...
		/* @__PURE__ */ jsxs("label", {
			...
			children: [busy ? "در حال بارگذاری…" : "آپلود PDF", /* @__PURE__ */ jsx("input", {
				type: "file",
