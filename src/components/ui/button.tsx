...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-[var(--radius-sm)] text-sm font-medium transition-[transform,background-color,box-shadow,opacity] duration-150 ease-[cubic-bezier(0.22,1,0.36,1)] disabled:pointer-events-none disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-turquoise/70 active:scale-[0.98]",
  {
    variants: {
      variant: {
        default:
          "bg-turquoise text-white shadow-card hover:bg-turquoise-dark",
        navy: "bg-navy text-white hover:bg-navy-mid",
        outline:
          "border border-line bg-white text-navy hover:border-turquoise hover:text-turquoise-dark",
