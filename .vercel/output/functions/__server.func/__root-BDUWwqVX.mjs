...
//#region node_modules/.nitro/vite/services/ssr/assets/__root-BDUWwqVX.js
...
var fetchSessionUser = createServerFn({ method: "GET" }).handler(fetchSessionUser_createServerFn_handler, async () => {
	const { getSessionUser } = await import("./_ssr/verify.server-BczJSy53.mjs").then((n) => n.n).then((n) => n.n);
	const { ensureAdminSeed } = await import("./_ssr/seed-admin.server-DS1zKlLD.mjs");
